...
if (isset($_POST['register'])) {
  ...
  if (
    ...
    array_push($debug, $firstName, $lastName, $email, $password, $rePassword);
...
<div class="row mt-5 ml-1 mr-1">
  <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1">
    <!-- <div class="card p-3"> -->
    <h3 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Welcome to Blog</h3>
    <p class="text-secondary">Let 's create your account
    </p>
    <hr>
    ...
    <form class="needs-validation" action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" novalidate>
      ...
      <div class="mb-3">
        <input type="password" class="form-control" id="password" placeholder="Confirm Password" value="<?= isset($rePassword) ? $rePassword : '' ?>" name="rePassword" required>
        <div class="invalid-feedback">
